...
function runTasks(f, pf)
    solutions = [
        mbisekcji(f, -1.0, 3.0, 1e-5, 1e-5),
        mbisekcji(f, -1.0, 2.0, 1e-5, 1e-5),
        mbisekcji(f, -1e6, 2.0, 1e-5, 1e-5),
        mbisekcji(f, -1e6, 1e6, 1e-5, 1e-5),
        mstycznych(f, pf, -2.0, 1e-5, 1e-5, 255),
        ...
        msiecznych(f, -2.0, 0.0, 1e-5, 1e-5, 255),
    ...
    methods = ["bisekcji na [-1, 3]", "bisekcji na [-1, 2]", "bisekcji na [-1e6, 2]", "bisekcji na [-1e6, 1e6]", 
               "Newtona dla x0=-2", "Newtona dla x0=-1","Newtona dla x0=1", "Newtona dla x0=1.5", "Newtona dla x0=4", "Newtona dla x0=8", "Newtona dla x0=1000",
               "siecznych na [0.0, 0.5]","siecznych na [-2.0, 0.0]", "siecznych na [0.5, 10000]", "siecznych na [-100, -90]", "siecznych na [100, 1000]", "siecznych na [1000, 1005]"]
